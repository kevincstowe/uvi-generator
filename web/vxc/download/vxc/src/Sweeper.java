...
public class Sweeper
{
   ...
   /**
    * When the Inspector is running in verb-frame pair mode, this integer
    * represents the frame number in the recursion chain.  This is somewhat
    * temporary as it does not represent a completely useful numbering scheme.
    * The first frame in each file is number 1.
    */
   ...
   private static void printVerbFramePairs()
   {
      ...
      if( Inspector.flVFPairsInvert )
      {
         ...
         for( int f = 0; f < curVFFrameList.size(); f++ )
         {
            ...
            // TEMPORARY: Although it doesn't give a perfect numbering, this variable
            // is used to identify the frames within a file.
            curVFFrameNum = f + 1;
